...
const BALL_FLOOR_SIZE = BASKETBALL_SIZE / 2;
const STEAL_HEIGHT = BASKETBALL_SIZE * 3 / 4;
const TRAVELLING_TIME = 20;
...
define("BALL_FLOOR_SIZE", BALL_FLOOR_SIZE);
define("STEAL_HEIGHT", STEAL_HEIGHT);
define("TRAVELLING_TIME", TRAVELLING_TIME);
